...
export const GENERATORS: GeneratorDef[] = [
  { id: 'gen_flower', chainId: 'flower', emoji: '🌻', name: 'Flower Pot', spawnTier: 1, cooldown: 500, cost: 0, unlockedAtLevel: 1 },
  { id: 'gen_butterfly', chainId: 'butterfly', emoji: '🪺', name: 'Nest', spawnTier: 1, cooldown: 500, cost: 100, unlockedAtLevel: 1 },
  { id: 'gen_fruit', chainId: 'fruit', emoji: '🧺', name: 'Basket', spawnTier: 1, cooldown: 500, cost: 200, unlockedAtLevel: 2 },
  { id: 'gen_crystal', chainId: 'crystal', emoji: '⛏️', name: 'Pickaxe', spawnTier: 1, cooldown: 500, cost: 500, unlockedAtLevel: 3 },
  { id: 'gen_nature', chainId: 'nature', emoji: '🪵', name: 'Stump', spawnTier: 1, cooldown: 500, cost: 800, unlockedAtLevel: 4 },
  { id: 'gen_tea', chainId: 'tea', emoji: '🍃', name: 'Tea Garden', spawnTier: 1, cooldown: 500, cost: 600, unlockedAtLevel: 6 },
