...
// Warm garden palette — golden hour kawaii
export const COLORS = {
  BG_CREAM: 0xFFF8F0,
  BG_PINK: 0xFFE4D9,
  BG_MINT: 0xFFF5EE,
  BOARD_BG: 0xFFF5EE,
  CELL_BG: 0xFFFAF5,
  CELL_BORDER: 0xF0D0B8,
  CELL_SHADOW: 0xDEB896,
  CELL_HIGHLIGHT: 0xF5D280,
  CELL_VALID: 0xF5D280,
  ...
  WARM_GOLD: 0xF5D280,
  GARDEN_GREEN: 0x8BC34A,
  WOOD_BROWN: 0xBCAAA4,
  BOARD_SHADOW: 0xBFA48A,
  BOARD_INNER_GLOW: 0xF5D280,
  // Y2K accent colors
